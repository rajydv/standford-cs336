...
def what_you_see():
    ...
    text("## Vibes")
    link("https://x.com/demishassabis/status/1919779362980692364")
...
def knowledge_benchmarks():
    text("## Massive Multitask Language Understanding (MMLU)"), link(mmlu)
    ...
    text("### Humanity's Last Exam"), link("https://arxiv.org/abs/2501.14249")
...
def instruction_following_benchmarks():
    ...
    text("## Instruction-Following Eval (IFEval)"), link("https://arxiv.org/abs/2311.07911")
    ...
    text("## AlpacaEval "), link("https://tatsu-lab.github.io/alpaca_eval/")
    ...
    text("Well-correlated (0.95) with Chatbot Arena")
...
def safety_benchmarks():
    ...
    text("Given 510 harmful behaviors that violate laws or norms")
    ...
    text("Two things: capabilities + propensity")
    text("A system could be capable of doing something, but refuse to do it")
    text("For API model, propensity matters")
...
def realism():
    ...
    text("Live traffic from real people contain garbage, that's not exactly what we want either")
    ...
    text("## Clio from Anthropic"), link("https://arxiv.org/abs/2412.13678")
    text("Use language models to analyze real user data")
    text("Share general patterns of what people are asking")

    text("## MedHELM"), link("https://arxiv.org/abs/2412.13678")
    ...
    text("Unfortunately, realism and privacy are at odds.")
...
def validity():
    ...
    text("Exploiting exchangeability in the benchmark"), link("https://arxiv.org/pdf/2310.17623")
...
def what_are_we_evaluating():
    ...
    text("Today, we're evaluating a system (anything goes)")
    ...
    text("These encourage algorithmic innovation from researchers.")
    text("Evaluating systems is useful for users.")

    text("Need to define the rules of the game!")
